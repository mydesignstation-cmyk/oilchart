...
export const products: Product[] = [
  ...
  { name: "15LTR TIN NEW", brand: "WHITE APPLE", oilType: "SF", packSize: 15, offsets: { SF: -105, SOYA: -47, PALM: -5 }, adjustments: { self: 15, other: 55, dealer: 70 } },
  { name: "15LTR JAR", brand: "WHITE APPLE", oilType: "SF", packSize: 15, offsets: { SF: -115, SOYA: -57, PALM: -15 }, adjustments: { self: 5, other: 45, dealer: 60 } },
  ...
  { name: "5LTR JAR(4)", brand: "WHITE APPLE", oilType: "SF", packSize: 5, offsets: { SF: -23, SOYA: -10, PALM: 13 }, adjustments: { self: 18, other: 33, dealer: 38 } },
  { name: "5LTR JAR(3) PET", brand: "WHITE APPLE", oilType: "SF", packSize: 5, offsets: { SF: -23, SOYA: -10, PALM: 13 }, adjustments: { self: 18, other: 33, dealer: 38 } },
  { name: "1LTR POUCH", brand: "WHITE APPLE", oilType: "SF", packSize: 1, offsets: { SF: -9.51, SOYA: -8.53, PALM: -2 }, adjustments: { self: -1.5, other: 1, dealer: 2 } },
  ...
  { name: "13KG TIN NEW", brand: "WHITE APPLE", oilType: "SOYA", packSize: 13, offsets: { SF: 150, SOYA: 150, PALM: 110 }, adjustments: { self: 136, other: 156, dealer: 166 } },
  ...
  { name: "840GM POUCH", brand: "WHITE APPLE", oilType: "SOYA", packSize: 0.84, offsets: { SF: 7.5, SOYA: 7.5, PALM: 6.5 }, adjustments: { self: 0, other: 0, dealer: 3.5 } },
