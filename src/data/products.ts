...
export const products: Product[] = [
  ...
  { name: "13KG JAR", brand: "WHITE APPLE", oilType: "SOYA", packSize: 13, offsets: { SF: 140, SOYA: 130, PALM: 110 }, adjustments: { self: 126, other: 146, dealer: 156 } },
  { name: "5LTR JAR", brand: "WHITE APPLE", oilType: "SOYA", packSize: 5, offsets: { SF: -13, SOYA: -10, PALM: 13 }, adjustments: { self: 18, other: 33, dealer: 38 } },
  ...
  { name: "840GM POUCH", brand: "WHITE APPLE", oilType: "SOYA", packSize: 0.84, offsets: { SF: 7.5, SOYA: 7.0, PALM: 6.5 }, adjustments: { self: 120, other: 140, dealer: 150 } },
