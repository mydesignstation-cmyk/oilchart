...
export const products: Product[] = [
  ...
  // BestTaste Soya variants
  {
    name: "14.800KG TIN (ST)",
    brand: "BESTTASTE",
    oilType: "SOYA",
    packSize: 14.8,
    offsets: { SF: 110.2, SOYA: 110.2, PALM: 110.2 },
    adjustments: { self: 110.2, other: 130.2, dealer: 140.2 },
  },
  {
    name: "13KG TIN (ST)",
    brand: "BESTTASTE",
  ...
  },
  {
    ...
    oilType: "SOYA",
    packSize: 12.8,
    offsets: { SF: 140.2, SOYA: 140.2, PALM: 140.2 },
    adjustments: { self: 140.2, other: 160.2, dealer: 170.2 },
  },
  {
    name: "900GM POUCH",
    brand: "BESTTASTE",
  ...
  },
  {
    ...
    oilType: "SOYA",
    packSize: 4.2,
    offsets: { SF: 62.8, SOYA: 62.8, PALM: 62.8 },
    adjustments: { self: 62.8, other: 82.8, dealer: 92.8 },
  },
  {
    name: "2LTR JAR",
    oilType: "SOYA",
    packSize: 2,
    offsets: { SF: 8, SOYA: 8, PALM: 8 },
    adjustments: { self: 8, other: 28, dealer: 38 },
  },
  {
    name: "1KG POUCH",
    oilType: "SOYA",
    packSize: 1,
    offsets: { SF: 7.5, SOYA: 7.5, PALM: 6.5 },
    adjustments: { self: 7.5, other: 27.5, dealer: 37.5 },
  },
  {
    name: "0.5KG POUCH",
    oilType: "SOYA",
    packSize: 0.5,
    offsets: { SF: 4.25, SOYA: 4.25, PALM: 4.25 },
    adjustments: { self: 4.25, other: 24.25, dealer: 34.25 },
  },
  {
    name: "1LTR POUCH",
    oilType: "SOYA",
    packSize: 1,
    offsets: { SF: -5.64, SOYA: -5.64, PALM: -5.64 },
    adjustments: { self: -5.64, other: 14.36, dealer: 24.36 },
  },
  {
    name: "0.5LTR POUCH",
    oilType: "SOYA",
    packSize: 0.5,
    offsets: { SF: -2.32, SOYA: -2.32, PALM: -2.32 },
    adjustments: { self: -2.32, other: 17.68, dealer: 27.68 },
  },
  {
    name: "840GM POUCH",
    oilType: "SOYA",
